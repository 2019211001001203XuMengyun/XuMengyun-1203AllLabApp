    ...
    public partial class frmCustomerDataEntry : Form
    {
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                objPreview.SetValues(txtCustomerName.Text, cmbCountry.Text,
                                     Gender, Hobby, Status);
                objPreview.Show();
            }
            catch (Exception ex)
        ...
        {
            string strConnection = "Data Source=DESKTOP-PGDC4US;Initial Catalog=CustomerDB;Persist Security Info=True;User ID=sa;Password=123456;Pooling=False";
